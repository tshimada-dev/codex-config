# codex-effort-estimator reference 日本語参考訳

このディレクトリには、`codex-effort-estimator` の reference 日本語参考訳を置いています。

Codex が実行時に読む canonical な定義は、リポジトリ直下の英語版 `skills/codex-effort-estimator/references/` です。内容が食い違う場合は英語版を優先します。
...
- [parametric-model-pass.md](parametric-model-pass.md): count driver と coefficient による parametric 見積もり
- [pert-pass.md](pert-pass.md): PERT 三点見積もり pass
- [public-review-pass.md](public-review-pass.md): 公共・帳票・受入観点レビュー pass
- [public-sector-business-systems.md](public-sector-business-systems.md): 公共・業務システムの見積もり観点
- [repetition-and-reuse.md](repetition-and-reuse.md): 反復・再利用による規模の経済
- [repo-cost-pass.md](repo-cost-pass.md): 既存 repository の再構築・完成見積もり
...
- [wbs-pass.md](wbs-pass.md): WBS ボトムアップ見積もり pass
- [workbook-format.md](workbook-format.md): 固定 Excel workbook format
