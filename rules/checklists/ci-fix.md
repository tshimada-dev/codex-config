...
- Transition to `codex-implementation` for the smallest relevant permanent fix, whether the cause is product behavior, configuration, dependency, or build logic.
