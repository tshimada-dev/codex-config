...
Use the project's existing handoff or planning location if present. If a file is warranted and no convention exists, create a short markdown note under `docs/handoffs/`.
